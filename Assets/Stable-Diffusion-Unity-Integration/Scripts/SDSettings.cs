...
public class SDSettings : ScriptableObject
{
    ...
    public string InternalProgressAPI = "/internal/progress";
    public string ControlNetModelsAPI = "/controlnet/model_list";
    public string TextToImageControlNetAPI = "/controlnet/txt2img";
    public string ImageToImageControlNetAPI = "/controlnet/img2img";
    public string OutputFolder = "__Project/Textures/Generated/";
...
class Args
{
    ...
    public string resize_mode = "Inner Fit (Scale to Fit)";
    public bool lowvram = false;
    public int processor_res = 64;
    public int threshold_a = 64;
    public int threshold_b = 64;
    public int guidance = 1;
    public int guidance_start = 0;
    public int guidance_end = 1;
...
/// <summary>
/// Data structure to help deserialize from a JSON the controlnetunit of the image generation.
/// </summary>
class SDControNetUnit
{
    public string input_image = "";
    public string mask = "";
    public string module = "";
    public string model = "";
    public float weight = 1;
    public string resize_mode = "Scale to Fit (Inner Fit)";
    public bool lowvram = false;
    public int processor_res = 64;
    public int threshold_a = 64;
    public int threshold_b = 64;
...
/// <summary>
/// Data structure to easily serialize the parameters to send to the
/// Stable Diffusion server when generating an image via ControlNet Txt2Img.
/// </summary>
class SDParamsInControlNetTxt2Img
{
    public bool enable_hr = false;
    public float denoising_strength = 0;
    public int firstphase_width = 0;
    ...
    public bool override_settings_restore_afterwards = true;
    public string sampler_index = "Euler";
    public SDControNetUnit[] controlnet_units;
}

class SDProgressRequest
{
    public string id_task = "";
    public int id_live_preview = -1;
}
...
/// <summary>
/// Data structure to help deserialize from a JSON the live progress status of an image generation.
/// </summary>
class SDInternalProgress
{
    public bool active;
    public bool queued;
